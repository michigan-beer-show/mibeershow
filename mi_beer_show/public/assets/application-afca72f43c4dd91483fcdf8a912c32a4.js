...
(function() {
  ...
  nested_form_fields.bind_nested_forms_links = function() {
    ...
    $('body').on('click', '.add_nested_fields_link', function() {
      var $child_templates, $link, $parsed_template, $template, added_index, association_path, index_placeholder, object_class, template_html;
      $link = $(this);
    ...
    return $('body').on('click', '.remove_nested_fields_link', function() {
      var $link, $nested_fields_container, delete_association_field_name, object_class, removed_index;
      $link = $(this);
      object_class = $link.data('object-class');
